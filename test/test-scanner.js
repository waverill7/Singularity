...
describe('The scanner', function () {
  ...
  it('properly handles comments and blank lines', function (done) {
    scan('test/data/good-programs/multiplication_table.sing', function (tokens) {
      ...
      i(tokens[27]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:7,col:18}))
      i(tokens[28]).should.equal(i({kind:',',lexeme:',',line:7,col:19}))
      i(tokens[29]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:21}))
      i(tokens[30]).should.equal(i({kind:'<=',lexeme:'<=',line:7,col:28}))
      i(tokens[31]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:7,col:31}))
      i(tokens[32]).should.equal(i({kind:',',lexeme:',',line:7,col:33}))
      i(tokens[33]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:35}))
      i(tokens[34]).should.equal(i({kind:'++',lexeme:'++',line:7,col:41}))
      i(tokens[35]).should.equal(i({kind:':',lexeme:':',line:7,col:43}))
      ...
      i(tokens[42]).should.equal(i({kind:']',lexeme:']',line:10,col:33}))
      i(tokens[43]).should.equal(i({kind:'[',lexeme:'[',line:10,col:34}))
      i(tokens[44]).should.equal(i({kind:'ID',lexeme:'column',line:10,col:35}))
      i(tokens[45]).should.equal(i({kind:']',lexeme:']',line:10,col:41}))
      i(tokens[46]).should.equal(i({kind:'=',lexeme:'=',line:10,col:43}))
      i(tokens[47]).should.equal(i({kind:'ID',lexeme:'row',line:10,col:45}))
      i(tokens[48]).should.equal(i({kind:'*',lexeme:'*',line:10,col:49}))
      i(tokens[49]).should.equal(i({kind:'ID',lexeme:'column',line:10,col:51}))
      i(tokens[50]).should.equal(i({kind:'Return',lexeme:'Return',line:10,col:57}))
