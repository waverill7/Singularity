...
describe('The scanner', function () {
  ...
  it('distinguishes reserved words and identifiers', function (done) {
    scan('test/data/token-tests/words', function (tokens) {
      ...
      i(tokens[14]).should.equal(i({kind:'self',lexeme:'self',line:1,col:85}))
      i(tokens[15]).should.equal(i({kind:'void',lexeme:'void',line:1,col:90}))
      i(tokens[16]).should.equal(i({kind:'u_byte',lexeme:'u_byte',line:1,col:95}))
      i(tokens[17]).should.equal(i({kind:'u_short',lexeme:'u_short',line:1,col:102}))
      i(tokens[18]).should.equal(i({kind:'u_int',lexeme:'u_int',line:1,col:110}))
      i(tokens[19]).should.equal(i({kind:'u_long',lexeme:'u_long',line:1,col:116}))
      i(tokens[20]).should.equal(i({kind:'byte',lexeme:'byte',line:1,col:123}))
      i(tokens[21]).should.equal(i({kind:'short',lexeme:'short',line:1,col:128}))
      i(tokens[22]).should.equal(i({kind:'int',lexeme:'int',line:1,col:134}))
      i(tokens[23]).should.equal(i({kind:'long',lexeme:'long',line:1,col:138}))
      i(tokens[24]).should.equal(i({kind:'float',lexeme:'float',line:1,col:143}))
      i(tokens[25]).should.equal(i({kind:'double',lexeme:'double',line:1,col:149}))
      i(tokens[26]).should.equal(i({kind:'or',lexeme:'or',line:1,col:156}))
      i(tokens[27]).should.equal(i({kind:'and',lexeme:'and',line:1,col:159}))
      i(tokens[28]).should.equal(i({kind:'not',lexeme:'not',line:1,col:163}))
      i(tokens[29]).should.equal(i({kind:'true',lexeme:'true',line:1,col:167}))
      i(tokens[30]).should.equal(i({kind:'false',lexeme:'false',line:1,col:172}))
      i(tokens[31]).should.equal(i({kind:'ID',lexeme:'whilexy',line:1,col:178}))
      i(tokens[32]).should.equal(i({kind:'ID',lexeme:'whil',line:1,col:186}))
      i(tokens[33]).should.equal(i({kind:'ID',lexeme:'ore',line:1,col:191}))
      i(tokens[34]).should.equal(i({kind:'ID',lexeme:'globallocal',line:1,col:195}))
      done()
    })
  })
