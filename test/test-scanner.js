...
describe('The scanner', function () {
  ...
  it('properly handles comments and blank lines', function (done) {
    scan('test/data/token-tests/multiplication_table.sing', function (tokens) {
      tokens.length.should.equal(53)
      i(tokens[0]).should.equal(i({kind:'global',lexeme:'global',line:2,col:1}))
      i(tokens[1]).should.equal(i({kind:'ID',lexeme:'multiplication_table',line:2,col:8}))
      i(tokens[2]).should.equal(i({kind:'=',lexeme:'=',line:2,col:29}))
      i(tokens[3]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:2,col:31}))
      i(tokens[4]).should.equal(i({kind:'#',lexeme:'#',line:2,col:34}))
      i(tokens[5]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:2,col:36}))
      i(tokens[6]).should.equal(i({kind:'Return',lexeme:'Return',line:2,col:38}))
      i(tokens[7]).should.equal(i({kind:'Return',lexeme:'Return',line:3,col:1}))
      i(tokens[8]).should.equal(i({kind:'for',lexeme:'for',line:5,col:1}))
      i(tokens[9]).should.equal(i({kind:'ID',lexeme:'row',line:5,col:5}))
      i(tokens[10]).should.equal(i({kind:'=',lexeme:'=',line:5,col:9}))
      i(tokens[11]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:5,col:11}))
      i(tokens[12]).should.equal(i({kind:',',lexeme:',',line:5,col:12}))
      i(tokens[13]).should.equal(i({kind:'ID',lexeme:'row',line:5,col:14}))
      i(tokens[14]).should.equal(i({kind:'<=',lexeme:'<=',line:5,col:18}))
      i(tokens[15]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:5,col:21}))
      i(tokens[16]).should.equal(i({kind:',',lexeme:',',line:5,col:23}))
      i(tokens[17]).should.equal(i({kind:'ID',lexeme:'row',line:5,col:25}))
      i(tokens[18]).should.equal(i({kind:'++',lexeme:'++',line:5,col:28}))
      i(tokens[19]).should.equal(i({kind:':',lexeme:':',line:5,col:30}))
      i(tokens[20]).should.equal(i({kind:'Return',lexeme:'Return',line:5,col:31}))
      i(tokens[21]).should.equal(i({kind:'Indent',lexeme:'Indent',line:6,col:1}))
      i(tokens[22]).should.equal(i({kind:'Return',lexeme:'Return',line:6,col:5}))
      i(tokens[23]).should.equal(i({kind:'for',lexeme:'for',line:8,col:5}))
      i(tokens[24]).should.equal(i({kind:'ID',lexeme:'column',line:8,col:9}))
      i(tokens[25]).should.equal(i({kind:'=',lexeme:'=',line:8,col:16}))
      i(tokens[26]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:8,col:18}))
      i(tokens[27]).should.equal(i({kind:',',lexeme:',',line:8,col:19}))
      i(tokens[28]).should.equal(i({kind:'ID',lexeme:'column',line:8,col:21}))
      i(tokens[29]).should.equal(i({kind:'<=',lexeme:'<=',line:8,col:28}))
      i(tokens[30]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:8,col:31}))
      i(tokens[31]).should.equal(i({kind:',',lexeme:',',line:8,col:33}))
      i(tokens[32]).should.equal(i({kind:'ID',lexeme:'column',line:8,col:35}))
      i(tokens[33]).should.equal(i({kind:'++',lexeme:'++',line:8,col:41}))
      i(tokens[34]).should.equal(i({kind:':',lexeme:':',line:8,col:43}))
      i(tokens[35]).should.equal(i({kind:'Return',lexeme:'Return',line:8,col:44}))
      i(tokens[36]).should.equal(i({kind:'Indent',lexeme:'Indent',line:9,col:1}))
      i(tokens[37]).should.equal(i({kind:'Return',lexeme:'Return',line:9,col:9}))
      i(tokens[38]).should.equal(i({kind:'ID',lexeme:'multiplication_table',line:11,col:9}))
      i(tokens[39]).should.equal(i({kind:'[',lexeme:'[',line:11,col:29}))
      i(tokens[40]).should.equal(i({kind:'ID',lexeme:'row',line:11,col:30}))
      i(tokens[41]).should.equal(i({kind:']',lexeme:']',line:11,col:33}))
      i(tokens[42]).should.equal(i({kind:'[',lexeme:'[',line:11,col:34}))
      i(tokens[43]).should.equal(i({kind:'ID',lexeme:'column',line:11,col:35}))
      i(tokens[44]).should.equal(i({kind:']',lexeme:']',line:11,col:41}))
      i(tokens[45]).should.equal(i({kind:'=',lexeme:'=',line:11,col:43}))
      i(tokens[46]).should.equal(i({kind:'ID',lexeme:'row',line:11,col:45}))
      i(tokens[47]).should.equal(i({kind:'*',lexeme:'*',line:11,col:49}))
      i(tokens[48]).should.equal(i({kind:'ID',lexeme:'column',line:11,col:51}))
      i(tokens[49]).should.equal(i({kind:'Return',lexeme:'Return',line:11,col:57}))
      i(tokens[50]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:12,col:1}))
      i(tokens[51]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:12,col:1}))
      i(tokens[52]).should.equal(i({kind:'EOF',lexeme:'EOF'}))
      done()
    })
  })
