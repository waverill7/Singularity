...
describe('The scanner', function () {
  ...
  it('properly handles comments and blank lines', function (done) {
    scan('test/data/good-programs/multiplicationTable.sing', function (tokens) {
      ...
      i(tokens[38]).should.equal(i({kind:'for',lexeme:'for',line:9,col:5}));
      i(tokens[39]).should.equal(i({kind:'ID',lexeme:'column',line:9,col:9}));
      i(tokens[40]).should.equal(i({kind:'=',lexeme:'=',line:9,col:16}));
      i(tokens[41]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:9,col:18}));
      i(tokens[42]).should.equal(i({kind:',',lexeme:',',line:9,col:19}));
      i(tokens[43]).should.equal(i({kind:'ID',lexeme:'column',line:9,col:21}));
      i(tokens[44]).should.equal(i({kind:'<=',lexeme:'<=',line:9,col:28}));
      i(tokens[45]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:9,col:31}));
      i(tokens[46]).should.equal(i({kind:',',lexeme:',',line:9,col:33}));
      i(tokens[47]).should.equal(i({kind:'ID',lexeme:'column',line:9,col:35}));
      i(tokens[48]).should.equal(i({kind:'+=',lexeme:'+=',line:9,col:42}));
      i(tokens[49]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:9,col:45}));
      i(tokens[50]).should.equal(i({kind:':',lexeme:':',line:9,col:46}));
      i(tokens[51]).should.equal(i({kind:'Return',lexeme:'Return',line:9,col:47}));
      i(tokens[52]).should.equal(i({kind:'Indent',lexeme:'Indent',line:10,col:1}));
      i(tokens[53]).should.equal(i({kind:'Return',lexeme:'Return',line:10,col:9}));
      i(tokens[54]).should.equal(i({kind:'Return',lexeme:'Return',line:11,col:9}));
      i(tokens[55]).should.equal(i({kind:'ID',lexeme:'multiplicationTable',line:12,col:9}));
      i(tokens[56]).should.equal(i({kind:'[',lexeme:'[',line:12,col:28}));
      i(tokens[57]).should.equal(i({kind:'ID',lexeme:'row',line:12,col:29}));
      i(tokens[58]).should.equal(i({kind:'-',lexeme:'-',line:12,col:32}));
      i(tokens[59]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:12,col:33}));
      i(tokens[60]).should.equal(i({kind:',',lexeme:',',line:12,col:34}));
      i(tokens[61]).should.equal(i({kind:'ID',lexeme:'column',line:12,col:36}));
      i(tokens[62]).should.equal(i({kind:'-',lexeme:'-',line:12,col:42}));
      i(tokens[63]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:12,col:43}));
      i(tokens[64]).should.equal(i({kind:']',lexeme:']',line:12,col:44}));
      i(tokens[65]).should.equal(i({kind:'=',lexeme:'=',line:12,col:46}));
      i(tokens[66]).should.equal(i({kind:'ID',lexeme:'row',line:12,col:48}));
      i(tokens[67]).should.equal(i({kind:'*',lexeme:'*',line:12,col:52}));
      i(tokens[68]).should.equal(i({kind:'ID',lexeme:'column',line:12,col:54}));
      i(tokens[69]).should.equal(i({kind:'Return',lexeme:'Return',line:12,col:60}));
      i(tokens[70]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:13,col:1}));
      i(tokens[71]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:13,col:1}));
      i(tokens[72]).should.equal(i({kind:'Return',lexeme:'Return',line:13,col:1}));
      i(tokens[73]).should.equal(i({kind:'EOF',lexeme:'EOF'}));
      done();
    });
  });
