...
describe('The scanner', function () {
  ...
  it('properly handles comments and blank lines', function (done) {
    scan('test/data/good-programs/multiplication_table.sing', function (tokens) {
      ...
      i(tokens[7]).should.equal(i({kind:'Return',lexeme:'Return',line:2,col:1}))
      i(tokens[8]).should.equal(i({kind:'Return', lexeme:'Return',line:3,col:1}))
      i(tokens[9]).should.equal(i({kind:'for',lexeme:'for',line:4,col:1}))
      i(tokens[10]).should.equal(i({kind:'@',lexeme:'@',line:4,col:5}))
      i(tokens[11]).should.equal(i({kind:'ID',lexeme:'row',line:4,col:7}))
      i(tokens[12]).should.equal(i({kind:'=',lexeme:'=',line:4,col:11}))
      i(tokens[13]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:4,col:13}))
      i(tokens[14]).should.equal(i({kind:',',lexeme:',',line:4,col:14}))
      i(tokens[15]).should.equal(i({kind:'ID',lexeme:'row',line:4,col:16}))
      i(tokens[16]).should.equal(i({kind:'<=',lexeme:'<=',line:4,col:20}))
      i(tokens[17]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:4,col:23}))
      i(tokens[18]).should.equal(i({kind:',',lexeme:',',line:4,col:25}))
      i(tokens[19]).should.equal(i({kind:'@',lexeme:'@',line:4,col:27}))
      i(tokens[20]).should.equal(i({kind:'ID',lexeme:'row',line:4,col:29}))
      i(tokens[21]).should.equal(i({kind:'++',lexeme:'++',line:4,col:32}))
      i(tokens[22]).should.equal(i({kind:':',lexeme:':',line:4,col:34}))
      i(tokens[23]).should.equal(i({kind:'Return',lexeme:'Return',line:4,col:35}))
      i(tokens[24]).should.equal(i({kind:'Indent',lexeme:'Indent',line:5,col:1}))
      i(tokens[25]).should.equal(i({kind:'Return',lexeme:'Return',line:5,col:5}))
      i(tokens[26]).should.equal(i({kind:'Return',lexeme:'Return',line:6,col:5}))
      i(tokens[27]).should.equal(i({kind:'for',lexeme:'for',line:7,col:5}))
      i(tokens[28]).should.equal(i({kind:'@',lexeme:'@',line:7,col:9}))
      i(tokens[29]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:11}))
      i(tokens[30]).should.equal(i({kind:'=',lexeme:'=',line:7,col:18}))
      i(tokens[31]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:7,col:20}))
      i(tokens[32]).should.equal(i({kind:',',lexeme:',',line:7,col:21}))
      i(tokens[33]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:23}))
      i(tokens[34]).should.equal(i({kind:'<=',lexeme:'<=',line:7,col:30}))
      i(tokens[35]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:7,col:33}))
      i(tokens[36]).should.equal(i({kind:',',lexeme:',',line:7,col:35}))
      i(tokens[37]).should.equal(i({kind:'@',lexeme:'@',line:7,col:37}))
      i(tokens[38]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:39}))
      i(tokens[39]).should.equal(i({kind:'++',lexeme:'++',line:7,col:45}))
      i(tokens[40]).should.equal(i({kind:':',lexeme:':',line:7,col:47}))
      i(tokens[41]).should.equal(i({kind:'Return',lexeme:'Return',line:7,col:48}))
      i(tokens[42]).should.equal(i({kind:'Indent',lexeme:'Indent',line:8,col:1}))
      i(tokens[43]).should.equal(i({kind:'Return',lexeme:'Return',line:8,col:9}))
      i(tokens[44]).should.equal(i({kind:'Return',lexeme:'Return',line:9,col:9}))
      i(tokens[45]).should.equal(i({kind:'@',lexeme:'@',line:10,col:9}))
      i(tokens[46]).should.equal(i({kind:'ID',lexeme:'multiplication_table',line:10,col:11}))
      i(tokens[47]).should.equal(i({kind:'[',lexeme:'[',line:10,col:31}))
      i(tokens[48]).should.equal(i({kind:'ID',lexeme:'row',line:10,col:32}))
      i(tokens[49]).should.equal(i({kind:']',lexeme:']',line:10,col:35}))
      i(tokens[50]).should.equal(i({kind:'[',lexeme:'[',line:10,col:36}))
      i(tokens[51]).should.equal(i({kind:'ID',lexeme:'column',line:10,col:37}))
      i(tokens[52]).should.equal(i({kind:']',lexeme:']',line:10,col:43}))
      i(tokens[53]).should.equal(i({kind:'=',lexeme:'=',line:10,col:45}))
      i(tokens[54]).should.equal(i({kind:'ID',lexeme:'row',line:10,col:47}))
      i(tokens[55]).should.equal(i({kind:'*',lexeme:'*',line:10,col:51}))
      i(tokens[56]).should.equal(i({kind:'ID',lexeme:'column',line:10,col:53}))
      i(tokens[57]).should.equal(i({kind:'Return',lexeme:'Return',line:10,col:59}))
      i(tokens[58]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:11,col:1}))
      i(tokens[59]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:11,col:1}))
      i(tokens[60]).should.equal(i({kind:'Return',lexeme:'Return',line:11,col:1}))
  ...
  it('reads symbolic tokens properly', function (done) {
    scan('test/data/token-tests/symbols', function (tokens) {
      ...
      i(tokens[28]).should.equal(i({kind:']',lexeme:']',line:1,col:38}))
      i(tokens[29]).should.equal(i({kind:'{',lexeme:'{',line:1,col:39}))
      i(tokens[30]).should.equal(i({kind:'}',lexeme:'}',line:1,col:40}))
      i(tokens[31]).should.equal(i({kind:'@',lexeme:'@',line:1,col:41}))
      done()
    })
  })
  ...
  it('distinguishes reserved words and identifiers', function (done) {
    scan('test/data/token-tests/words', function (tokens) {
      ...
      i(tokens[10]).should.equal(i({kind:'object',lexeme:'object',line:1,col:78}))
      i(tokens[11]).should.equal(i({kind:'self',lexeme:'self',line:1,col:85}))
      i(tokens[12]).should.equal(i({kind:'void',lexeme:'void',line:1,col:90}))
      i(tokens[13]).should.equal(i({kind:'u_byte',lexeme:'u_byte',line:1,col:95}))
      i(tokens[14]).should.equal(i({kind:'u_short',lexeme:'u_short',line:1,col:102}))
      i(tokens[15]).should.equal(i({kind:'u_int',lexeme:'u_int',line:1,col:110}))
      i(tokens[16]).should.equal(i({kind:'u_long',lexeme:'u_long',line:1,col:116}))
      i(tokens[17]).should.equal(i({kind:'byte',lexeme:'byte',line:1,col:123}))
      i(tokens[18]).should.equal(i({kind:'short',lexeme:'short',line:1,col:128}))
      i(tokens[19]).should.equal(i({kind:'int',lexeme:'int',line:1,col:134}))
      i(tokens[20]).should.equal(i({kind:'long',lexeme:'long',line:1,col:138}))
      i(tokens[21]).should.equal(i({kind:'float',lexeme:'float',line:1,col:143}))
      i(tokens[22]).should.equal(i({kind:'double',lexeme:'double',line:1,col:149}))
      i(tokens[23]).should.equal(i({kind:'or',lexeme:'or',line:1,col:156}))
      i(tokens[24]).should.equal(i({kind:'and',lexeme:'and',line:1,col:159}))
      i(tokens[25]).should.equal(i({kind:'not',lexeme:'not',line:1,col:163}))
      i(tokens[26]).should.equal(i({kind:'true',lexeme:'true',line:1,col:167}))
      i(tokens[27]).should.equal(i({kind:'false',lexeme:'false',line:1,col:172}))
      i(tokens[28]).should.equal(i({kind:'ID',lexeme:'whilexy',line:1,col:178}))
      i(tokens[29]).should.equal(i({kind:'ID',lexeme:'whil',line:1,col:186}))
      i(tokens[30]).should.equal(i({kind:'ID',lexeme:'ore',line:1,col:191}))
      i(tokens[31]).should.equal(i({kind:'ID',lexeme:'globallocal',line:1,col:195}))
      done()
    })
  })
