...
describe('The scanner', function () {
  ...
  it('properly handles comments and blank lines', function (done) {
    scan('test/data/good-programs/multiplication_table.sing', function (tokens) {
      ...
      i(tokens[10]).should.equal(i({kind:'@',lexeme:'@',line4,col:3}))
      i(tokens[11]).should.equal(i({kind:'ID',lexeme:'row',line:4,col:5}))
      i(tokens[12]).should.equal(i({kind:'=',lexeme:'=',line:4,col:9}))
      i(tokens[13]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:4,col:11}))
      i(tokens[14]).should.equal(i({kind:',',lexeme:',',line:4,col:12}))
      i(tokens[15]).should.equal(i({kind:'ID',lexeme:'row',line:4,col:14}))
      i(tokens[16]).should.equal(i({kind:'<=',lexeme:'<=',line:4,col:18}))
      i(tokens[17]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:4,col:21}))
      i(tokens[18]).should.equal(i({kind:',',lexeme:',',line:4,col:23}))
      i(tokens[19]).should.equal(i({kind:'ID',lexeme:'row',line:4,col:25}))
      i(tokens[20]).should.equal(i({kind:'++',lexeme:'++',line:4,col:28}))
      i(tokens[21]).should.equal(i({kind:':',lexeme:':',line:4,col:30}))
      i(tokens[22]).should.equal(i({kind:'Return',lexeme:'Return',line:4,col:31}))
      i(tokens[23]).should.equal(i({kind:'Indent',lexeme:'Indent',line:5,col:1}))
      i(tokens[24]).should.equal(i({kind:'Return',lexeme:'Return',line:5,col:5}))
      i(tokens[25]).should.equal(i({kind:'Return',lexeme:'Return',line:6,col:5}))
      i(tokens[26]).should.equal(i({kind:'for',lexeme:'for',line:7,col:5}))
      i(tokens[27]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:9}))
      i(tokens[28]).should.equal(i({kind:'=',lexeme:'=',line:7,col:16}))
      i(tokens[29]).should.equal(i({kind:'IntegerLiteral',lexeme:'1',line:7,col:18}))
      i(tokens[30]).should.equal(i({kind:',',lexeme:',',line:7,col:19}))
      i(tokens[31]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:21}))
      i(tokens[32]).should.equal(i({kind:'<=',lexeme:'<=',line:7,col:28}))
      i(tokens[33]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:7,col:31}))
      i(tokens[34]).should.equal(i({kind:',',lexeme:',',line:7,col:33}))
      i(tokens[35]).should.equal(i({kind:'ID',lexeme:'column',line:7,col:35}))
      i(tokens[36]).should.equal(i({kind:'++',lexeme:'++',line:7,col:41}))
      i(tokens[37]).should.equal(i({kind:':',lexeme:':',line:7,col:43}))
      i(tokens[38]).should.equal(i({kind:'Return',lexeme:'Return',line:7,col:44}))
      i(tokens[39]).should.equal(i({kind:'Indent',lexeme:'Indent',line:8,col:1}))
      i(tokens[40]).should.equal(i({kind:'Return',lexeme:'Return',line:8,col:9}))
      i(tokens[41]).should.equal(i({kind:'Return',lexeme:'Return',line:9,col:9}))
      i(tokens[42]).should.equal(i({kind:'ID',lexeme:'multiplication_table',line:10,col:9}))
      i(tokens[43]).should.equal(i({kind:'[',lexeme:'[',line:10,col:29}))
      i(tokens[44]).should.equal(i({kind:'ID',lexeme:'row',line:10,col:30}))
      i(tokens[45]).should.equal(i({kind:']',lexeme:']',line:10,col:33}))
      i(tokens[46]).should.equal(i({kind:'[',lexeme:'[',line:10,col:34}))
      i(tokens[47]).should.equal(i({kind:'ID',lexeme:'column',line:10,col:35}))
      i(tokens[48]).should.equal(i({kind:']',lexeme:']',line:10,col:41}))
      i(tokens[49]).should.equal(i({kind:'=',lexeme:'=',line:10,col:43}))
      i(tokens[50]).should.equal(i({kind:'ID',lexeme:'row',line:10,col:45}))
      i(tokens[51]).should.equal(i({kind:'*',lexeme:'*',line:10,col:49}))
      i(tokens[52]).should.equal(i({kind:'ID',lexeme:'column',line:10,col:51}))
      i(tokens[53]).should.equal(i({kind:'Return',lexeme:'Return',line:10,col:57}))
      i(tokens[54]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:11,col:1}))
      i(tokens[55]).should.equal(i({kind:'Dedent',lexeme:'Dedent',line:11,col:1}))
      i(tokens[56]).should.equal(i({kind:'Return',lexeme:'Return',line:11,col:1}))
      i(tokens[57]).should.equal(i({kind:'EOF',lexeme:'EOF'}))
      done()
    })
  })
