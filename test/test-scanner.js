...
describe('The scanner', function () {
  ...
  it('properly handles comments and blank lines', function (done) {
    scan('test/data/token-tests/multiplication_table.sing', function (tokens) {
      ...
      i(tokens[2]).should.equal(i({kind:'ID',lexeme:'multiplication_table',line:2,col:8}))
      i(tokens[3]).should.equal(i({kind:'=',lexeme:'=',line:2,col:29}))
      i(tokens[4]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:2,col:31}))
      i(tokens[5]).should.equal(i({kind:'#',lexeme:'#',line:2,col:34}))
      i(tokens[6]).should.equal(i({kind:'IntegerLiteral',lexeme:'10',line:2,col:36}))
      i(tokens[7]).should.equal(i({kind:'Return',lexeme:'Return',line:2,col:38}))
      ...
      i(tokens[20]).should.equal(i({kind:'++',lexeme:'++',line:5,col:28}))
      i(tokens[21]).should.equal(i({kind:':',lexeme:':',line:5,col:30}))
      i(tokens[22]).should.equal(i({kind:'Return',lexeme:'Return',line:5,col:31}))
      i(tokens[23]).should.equal(i({kind:'Indent',lexeme:'Indent',line:6,col:1}))
      i(tokens[24]).should.equal(i({kind:'Return',lexeme:'Return',line:6,col:5}))
      i(tokens[25]).should.equal(i({kind:'Return',lexeme:'Return',line:7,col:1}))
      i(tokens[26]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[27]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[28]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[29]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[30]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[31]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[32]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[33]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[34]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[35]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[36]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[37]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[38]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[39]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[40]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[41]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[42]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[43]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[44]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[45]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[46]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[47]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[48]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[49]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[50]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[51]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[52]).should.equal(i({kind:'var',lexeme:'var',line:1,col:1}))
      i(tokens[53]).should.equal(i({kind:'EOF',lexeme:'EOF'}))
      done()
    })
  })
