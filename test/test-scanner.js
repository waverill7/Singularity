...
describe('The scanner', function () {
  ...
  it('distinguishes reserved words and identifiers', function (done) {
    scan('test/data/token-tests/words', function (tokens) {
      ...
      i(tokens[13]).should.equal(i({kind:'u_byte',lexeme:'u_byte',line:1,col:75}))
      i(tokens[14]).should.equal(i({kind:'u_short',lexeme:'u_short',line:1,col:82}))
      i(tokens[15]).should.equal(i({kind:'u_int',lexeme:'u_int',line:1,col:90}))
      i(tokens[16]).should.equal(i({kind:'u_long',lexeme:'u_long',line:1,col:96}))
      i(tokens[17]).should.equal(i({kind:'byte',lexeme:'byte',line:1,col:103}))
      i(tokens[18]).should.equal(i({kind:'short',lexeme:'short',line:1,col:108}))
      i(tokens[19]).should.equal(i({kind:'int',lexeme:'int',line:1,col:114}))
      i(tokens[20]).should.equal(i({kind:'long',lexeme:'long',line:1,col:118}))
      i(tokens[21]).should.equal(i({kind:'float',lexeme:'float',line:1,col:123}))
      i(tokens[22]).should.equal(i({kind:'double',lexeme:'double',line:1,col:129}))
      i(tokens[23]).should.equal(i({kind:'or',lexeme:'or',line:1,col:136}))
      i(tokens[24]).should.equal(i({kind:'and',lexeme:'and',line:1,col:139}))
      i(tokens[25]).should.equal(i({kind:'not',lexeme:'not',line:1,col:143}))
      i(tokens[26]).should.equal(i({kind:'true',lexeme:'true',line:1,col:147}))
      i(tokens[27]).should.equal(i({kind:'false',lexeme:'false',line:1,col:152}))
      i(tokens[28]).should.equal(i({kind:'ID',lexeme:'whilexy',line:1,col:158}))
      i(tokens[29]).should.equal(i({kind:'ID',lexeme:'whil',line:1,col:166}))
      i(tokens[30]).should.equal(i({kind:'ID',lexeme:'ore',line:1,col:171}))
      i(tokens[31]).should.equal(i({kind:'ID',lexeme:'globallocal',line:1,col:175}))
      done()
    })
  })
