...
describe('The scanner', function () {
  ...
  it('reads characters properly', function (done) {
    scan('test/data/token-tests/characters', function (tokens) {
      ...
      i(tokens[54]).should.equal(i({kind:'CharacterLiteral',lexeme:''1'',line:1,col:213}))
      i(tokens[55]).should.equal(i({kind:'CharacterLiteral',lexeme:''!'',line:1,col:213}))
      i(tokens[56]).should.equal(i({kind:'CharacterLiteral',lexeme:''2'',line:1,col:217}))
      i(tokens[57]).should.equal(i({kind:'CharacterLiteral',lexeme:''@'',line:1,col:221}))
      i(tokens[58]).should.equal(i({kind:'CharacterLiteral',lexeme:''3'',line:1,col:225}))
      i(tokens[59]).should.equal(i({kind:'CharacterLiteral',lexeme:''#'',line:1,col:229}))
      i(tokens[60]).should.equal(i({kind:'CharacterLiteral',lexeme:''4'',line:1,col:233}))
      i(tokens[61]).should.equal(i({kind:'CharacterLiteral',lexeme:''$'',line:1,col:237}))
      i(tokens[62]).should.equal(i({kind:'CharacterLiteral',lexeme:''5'',line:1,col:241}))
      i(tokens[63]).should.equal(i({kind:'CharacterLiteral',lexeme:''%'',line:1,col:245}))
      i(tokens[64]).should.equal(i({kind:'CharacterLiteral',lexeme:''6'',line:1,col:249}))
      i(tokens[65]).should.equal(i({kind:'CharacterLiteral',lexeme:''^'',line:1,col:253}))
      i(tokens[66]).should.equal(i({kind:'CharacterLiteral',lexeme:''7'',line:1,col:257}))
      i(tokens[67]).should.equal(i({kind:'CharacterLiteral',lexeme:''&'',line:1,col:261}))
      i(tokens[68]).should.equal(i({kind:'CharacterLiteral',lexeme:''8'',line:1,col:265}))
      i(tokens[69]).should.equal(i({kind:'CharacterLiteral',lexeme:''*'',line:1,col:269}))
      i(tokens[70]).should.equal(i({kind:'CharacterLiteral',lexeme:''9'',line:1,col:273}))
      i(tokens[71]).should.equal(i({kind:'CharacterLiteral',lexeme:''('',line:1,col:277}))
      i(tokens[72]).should.equal(i({kind:'CharacterLiteral',lexeme:''0'',line:1,col:281}))
      i(tokens[73]).should.equal(i({kind:'CharacterLiteral',lexeme:'')'',line:1,col:285}))
      i(tokens[74]).should.equal(i({kind:'CharacterLiteral',lexeme:''-'',line:1,col:289}))
      i(tokens[75]).should.equal(i({kind:'CharacterLiteral',lexeme:''_'',line:1,col:293}))
      i(tokens[76]).should.equal(i({kind:'CharacterLiteral',lexeme:''='',line:1,col:297}))
      i(tokens[77]).should.equal(i({kind:'CharacterLiteral',lexeme:''+'',line:1,col:401}))
      i(tokens[78]).should.equal(i({kind:'CharacterLiteral',lexeme:''['',line:1,col:405}))
      i(tokens[79]).should.equal(i({kind:'CharacterLiteral',lexeme:''{'',line:1,col:409}))
      i(tokens[80]).should.equal(i({kind:'CharacterLiteral',lexeme:'']'',line:1,col:413}))
      i(tokens[81]).should.equal(i({kind:'CharacterLiteral',lexeme:''}'',line:1,col:417}))
      i(tokens[82]).should.equal(i({kind:'CharacterLiteral',lexeme:''\'',line:1,col:421}))
      i(tokens[83]).should.equal(i({kind:'CharacterLiteral',lexeme:''|'',line:1,col:425}))
      i(tokens[84]).should.equal(i({kind:'CharacterLiteral',lexeme:'';'',line:1,col:429}))
      i(tokens[85]).should.equal(i({kind:'CharacterLiteral',lexeme:'':'',line:1,col:433}))
      i(tokens[86]).should.equal(i({kind:'CharacterLiteral',lexeme:'','',line:1,col:437}))
      i(tokens[87]).should.equal(i({kind:'CharacterLiteral',lexeme:''<'',line:1,col:441}))
      i(tokens[88]).should.equal(i({kind:'CharacterLiteral',lexeme:''.'',line:1,col:445}))
      i(tokens[89]).should.equal(i({kind:'CharacterLiteral',lexeme:''>'',line:1,col:449}))
      i(tokens[90]).should.equal(i({kind:'CharacterLiteral',lexeme:''/'',line:1,col:453}))
      i(tokens[91]).should.equal(i({kind:'CharacterLiteral',lexeme:''?'',line:1,col:457}))
      i(tokens[92]).should.equal(i({kind:'CharacterLiteral',lexeme:'' '',line:1,col:461}))
      done()
    })
  })
  ...
  it('scans strings properly', function (done) {
    scan('test/data/token-tests/strings', function (tokens) {
      ...
      i(tokens[5]).should.equal(i({kind:'StringLiteral',lexeme:'" "',line:1,col:72}))
      i(tokens[6]).should.equal(i({kind:'StringLiteral',lexeme:'"while x > 0:"',line:1,col:76}))
      done()
    })
  })   
